const TeamSection = () => {
  return (
    <section className="flex items-center justify-center h-[500px] bg-white sm-1:px-4 sm:px-4 md:px-0">
      <div>
        <div className="text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-70">
              ...
              address even the most complex financial challenges. We are
              dedicated to ongoing professional development to stay at the
